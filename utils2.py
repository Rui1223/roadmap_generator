...
def planScene_generation(Objects, benchmarkType, static_geometries, 
														folderFile, nhypo, noise, cc, nn, clientId):
	meshSet = []
	mostPromisingLabelIdx = []
	labelIdx = 0
	nObjectInPlanning = 0
	currentLabelWeightsFile = folderFile + "/labelWeights_" + str(cc) + "_" + str(nn) + ".txt"
	...
	currentMostPromisingLabelsFile = folderFile + "/mostPromisingLabels_" + str(cc) + "_" + str(nn) + ".txt"
