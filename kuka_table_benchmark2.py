...
Objects[0] = [0, "/mesh/rawlings_baseball/rawlings_baseball.obj", "baseball", 
	"target", 2, [0.13, -0.02, 0.27], [0.0, 0.0, 0.0], [0.05, 0.05], 1]
...
"crayola", "normal", 2, [0.15, -0.15, 0.3], [math.pi/2, 0.0, -math.pi/4], 
														[0.04, 0.03, 0.18], 1]
...
Objects[3] = [3, "/mesh/dove_beauty_bar/dove_beauty_bar.obj", "doveBar", 
	"normal", 2, [-0.11, -0.19, 0.25], [math.pi/2, 0.0, math.pi/1.3], [0.03, 0.06, 0.01], 1]
