...
nHypo = int(sys.argv[3]) # choose nHypo from "3" and "4" (1-7)
noiseLevel = float(sys.argv[4]) # choose "1.2" (1.0-4.0)
nsamples = int(sys.argv[5]) # choose 2000 (1000-5000)
...
######################################################################
	...
	if scene == "1":
		...
		# meshfile, meshType, objectRole, scale, true_pos, true_angles, uncertainty, nHypo
		Objects[0] = [0, "/mesh/rawlings_baseball/rawlings_baseball.obj", "baseball", 
			"target", 1.67, [0.155, -0.01, 0.07+table_dim[2]], [math.pi/5.8, math.pi/0.4, math.pi/2.3], 
											[0.012, 0.013, 0.45]]
		# Objects[0] = [0, "/mesh/rawlings_baseball/rawlings_baseball.obj", "baseball", 
		...
		Objects[1] = [1, "/mesh/kleenex_tissue_box/kleenex_tissue_box.obj", 
			"tissueBox", "normal", 1.65, [0.06, 0.16, 0.1+table_dim[2]], [0.0, -math.pi/2, -math.pi/3], 
		...
		# pick goal offset
		goalPos_offset = [0.0, 0.0, 0.16]
		# goalPos_offset = [0.3, 0.0, 0.275]
		# goalPos_offset = [0.8, 0.0, 0.17]
		goalEuler = [0.0, math.pi, 0.0] ## tabletop picking
		x_ll = kukaBasePosition[0] - 0.2
		x_ul = tablePosition[0] + table_dim[0]/2
		y_ll = -table_dim[1]/2
		...
		##################################### for image ###################################################
		Objects[0] = [0, "/mesh/rawlings_baseball/rawlings_baseball.obj", "baseball", 
				"target", 1.9, [0.11, 0.215, 0.07+table_dim[2]], 
						[2*math.pi/7.0, math.pi/4.8, 7*math.pi/6.2], [0.04, 0.04, 1.04]]
		# Objects[0] = [0, "/mesh/rawlings_baseball/rawlings_baseball.obj", "baseball", 
		...
		Objects[1] = [1, "/mesh/dove_beauty_bar/dove_beauty_bar.obj", "doveBar", 
				"normal", 2, [0.23, 0.3, 0.05+table_dim[2]], [math.pi/2, 0.0, 
														math.pi/4.3], [0.03, 0.03, 0.36]]
		Objects[2] = [2, "/mesh/dasani_water_bottle/dasani_water_bottle.obj", "waterBottle", 
				"normal", 2, [-0.09, 0.3, 0.2+table_dim[2]], [math.pi/2, 0.0, 
														math.pi/2.6], [0.03, 0.03, 0.67]]
		Objects[3] = [3, "/mesh/ticonderoga_12_pencils/ticonderoga_12_pencils.obj", "pencils", 
				"normal", 1, [0.18, -0.15, 0.01+table_dim[2]], 
									[0.0, -math.pi/2, -math.pi/8.8], [0.03, 0.03, 0.32]]
		Objects[4] = [4, "/mesh/up_glucose_bottle/up_glucose_bottle.obj", 
				"glucoseBottle", "normal", 1.5, [0.275, 0.13, 0.1+table_dim[2]], 
											[math.pi / 2, 0.0, math.pi], [0.04, 0.04, 0.42]]
		Objects[5] = [5, "/mesh/crayola_24_ct/crayola_24_ct.obj", 
				"crayola", "normal", 2, [-0.13, 0.16, 0.09+table_dim[2]], 
											[math.pi/2, 0.0, math.pi/3], [0.03, 0.02, 0.37]]
		Objects[6] = [6, "/mesh/kleenex_tissue_box/kleenex_tissue_box.obj", 
				"tissueBox", "normal", 1.5, [0.0, 0.0, 0.1+table_dim[2]], 
										[0.0, -math.pi/2, -math.pi/3], [0.02, 0.02, 0.28]]
		Objects[7] = [7, "/mesh/dr_browns_bottle_brush/dr_browns_bottle_brush.obj", 
				"brush", "normal", 1, [-0.21, -0.23, 0.02+table_dim[2]], 
											[0.0, 0.0, 1.7*math.pi / 4.5], [0.02, 0.01, 0.2]]
		Objects[8] = [8, "/mesh/soft_white_lightbulb/soft_white_lightbulb.obj", 
				"lightbulb", "phantom", 1.5, [0.16, 0.52, 0.05+table_dim[2]], 
										[0.0, math.pi, 4*math.pi/6.7], [0.032, 0.035, 0.14]]
		Objects[9] = [9, "/mesh/elmers_washable_no_run_school_glue/elmers_washable_no_run_school_glue.obj", 
				"glue", "normal", 1.5, [0.02, 0.39, 0.11+table_dim[2]], 
									[math.pi / 2, 0.0, 67*math.pi/180], [0.03, 0.04, 0.52]]
		##################################### for demo ###################################################
		# Objects[0] = [0, "/mesh/rawlings_baseball/rawlings_baseball.obj", "baseball", 
		# 		"target", 1.9, [0.11, 0.215, 0.07+table_dim[2]], 
		# 				[2*math.pi/7.0, math.pi/4.8, 7*math.pi/6.2], [0.05, 0.05, 1.04]]
		...
		# # 				[2*math.pi/7.0, math.pi/4.8, 7*math.pi/6.2], [0.05, 0.05, 1.04]]
		# Objects[1] = [1, "/mesh/dove_beauty_bar/dove_beauty_bar.obj", "doveBar", 
		# 		"normal", 2, [0.22, 0.3, 0.05+table_dim[2]], [math.pi/2, 0.0, 
		...
		# Objects[6] = [6, "/mesh/kleenex_tissue_box/kleenex_tissue_box.obj", 
		# 		"tissueBox", "normal", 1.6, [0.0, 0.0, 0.1+table_dim[2]], 
		...
		##################################### original ###################################################
		# Objects[0] = [0, "/mesh/rawlings_baseball/rawlings_baseball.obj", "baseball", 
		# 		"target", 2, [0.16, 0.215, 0.07+table_dim[2]], 
		# 				[2*math.pi/7.0, math.pi/4.8, 7*math.pi/6.2], [0.05, 0.05, 1.04]]
		# Objects[1] = [1, "/mesh/dove_beauty_bar/dove_beauty_bar.obj", "doveBar", 
		# 		"normal", 2, [0.27, 0.38, 0.05+table_dim[2]], [math.pi/2, 0.0, 
		# 												math.pi/4.3], [0.03, 0.06, 0.27]]
		# Objects[2] = [2, "/mesh/dasani_water_bottle/dasani_water_bottle.obj", "waterBottle", 
		# 		"normal", 2, [-0.09, 0.31, 0.2+table_dim[2]], [math.pi/2, 0.0, 
		# 												math.pi/2.6], [0.05, 0.04, 0.67]]
		# Objects[3] = [3, "/mesh/ticonderoga_12_pencils/ticonderoga_12_pencils.obj", "pencils", 
		...
		# 							[0.0, -math.pi/2, -math.pi/8.8], [0.05, 0.04, 0.32]]
		# Objects[4] = [4, "/mesh/up_glucose_bottle/up_glucose_bottle.obj", 
		# 		"glucoseBottle", "normal", 1.5, [0.28, 0.11, 0.1+table_dim[2]], 
		# 									[math.pi / 2, 0.0, math.pi], [0.04, 0.04, 0.42]]
		# Objects[5] = [5, "/mesh/crayola_24_ct/crayola_24_ct.obj", 
		# 		"crayola", "normal", 2, [-0.09, 0.16, 0.09+table_dim[2]], 
		# 									[math.pi/2, 0.0, math.pi/3], [0.04, 0.03, 0.28]]
		# Objects[6] = [6, "/mesh/kleenex_tissue_box/kleenex_tissue_box.obj", 
		# 		"tissueBox", "normal", 1.5, [0.0, 0.0, 0.1+table_dim[2]], 
		# 								[0.0, -math.pi/2, -math.pi/3], [0.03, 0.03, 0.24]]
		# Objects[7] = [7, "/mesh/dr_browns_bottle_brush/dr_browns_bottle_brush.obj", 
		...
		# Objects[8] = [8, "/mesh/soft_white_lightbulb/soft_white_lightbulb.obj", 
		# 		"lightbulb", "phantom", 1.5, [0.12, 0.52, 0.05+table_dim[2]], 
		# 								[0.0, math.pi, 4*math.pi/6.7], [0.032, 0.035, 0.28]]
		# Objects[9] = [9, "/mesh/elmers_washable_no_run_school_glue/elmers_washable_no_run_school_glue.obj", 
		# 		"glue", "normal", 1.5, [0.03, 0.31, 0.11+table_dim[2]], 
		# 							[math.pi / 2, 0.0, 67*math.pi/180], [0.07, 0.07, 0.5]]
		# pick goal offset
		goalPos_offset = [0.0, 0.0, 0.16]
		# goalPos_offset = [0.08, 0.0, 0.16]
		# goalPos_offset = [0.2, 0.1, 0.25]
		goalEuler = [0.0, math.pi, 0.0] ## tabletop picking
		x_ll = kukaBasePosition[0] - 0.2
		x_ul = tablePosition[0] + table_dim[0]/2
		y_ll = -table_dim[1]/2
...
######################################################################
	if scene == "1":
		...
		Objects[0] = [0, "/mesh/dasani_water_bottle/dasani_water_bottle.obj", "waterBottle", 
			"target", 1.7, [0.0362, 0.33, 0.17+middleflatPosition[2]+flat_dim[2]/2], 
												[math.pi/2, 0.0, 0.0], [0.05, 0.04, 0.3]]
		Objects[1] = [1, "/mesh/soft_white_lightbulb/soft_white_lightbulb.obj", 
			"lightbulb", "normal", 1.5, [-0.12, 0.18, 0.07+middleflatPosition[2]+flat_dim[2]/2], 
		...
		Objects[2] = [2, "/mesh/elmers_washable_no_run_school_glue/elmers_washable_no_run_school_glue.obj", 
			"glue", "normal", 1.5, [-0.065, 0.41, 0.1+middleflatPosition[2]+flat_dim[2]/2], 
										[math.pi / 2, 0.0, 25*math.pi/180], [0.07, 0.02, 0.5]]
		Objects[3] = [3, "/mesh/kleenex_tissue_box/kleenex_tissue_box.obj", 
		...
		Objects[0] = [0, "/mesh/dasani_water_bottle/dasani_water_bottle.obj", "waterBottle", 
			"target", 1.8, [0.152, 0.45, 0.2+middleflatPosition[2]+flat_dim[2]/2], 
		...
		Objects[7] = [7, "/mesh/crayola_24_ct/crayola_24_ct.obj", 
			"crayola", "normal", 2, [-0.3, 0.255, 0.1+middleflatPosition[2]+flat_dim[2]/2], 
...
if mode == "g":
	utils1.executeAllTraj_example(home_configuration, kukaID_e, truePoses, path, executingServer)
else:
	...
	p.stepSimulation(executingServer)

	utils1.executeTraj(kukaID_e, "/Astartraj_", truePoses, path, idx1, idx2, executingServer)
	raw_input("delete the scene!")
	utils1.deleteTruePoses(truePoses, executingServer)
	## Put the kuka back to its home configuration
	raw_input("Press to put kuka to home configuration")
	for i in range(1,8):
		result = p.resetJointState(kukaID_e, i, home_configuration[i-1], physicsClientId=executingServer)
	p.stepSimulation(executingServer)
	raw_input("re-generating the scene")
	truePoses, nObjectInExecuting = utils1.trueScene_generation(bt, scene, Objects, executingServer)

	utils1.executeTraj(kukaID_e, "/MCRGtraj_", truePoses, path, idx1, idx2, executingServer)
	raw_input("delete the scene!")
	utils1.deleteTruePoses(truePoses, executingServer)
	raw_input("Press to put kuka to home configuration")
	## Put the kuka back to its home configuration
	...
	utils1.executeTraj(kukaID_e, "/MCREtraj_", truePoses, path, idx1, idx2, executingServer)
	raw_input("delete the scene!")
	utils1.deleteTruePoses(truePoses, executingServer)
	raw_input("Press to put kuka to home configuration")
	## Put the kuka back to its home configuration
	...
	utils1.executeTraj(kukaID_e, "/MSGtraj_", truePoses, path, idx1, idx2, executingServer)
	raw_input("delete the scene!")
	utils1.deleteTruePoses(truePoses, executingServer)
	raw_input("Press to put kuka to home configuration")
	## Put the kuka back to its home configuration
	...
	utils1.executeTraj(kukaID_e, "/MSEtraj_", truePoses, path, idx1, idx2, executingServer)
	raw_input("delete the scene!")
	utils1.deleteTruePoses(truePoses, executingServer)
	raw_input("Press to put kuka to home configuration")
	## Put the kuka back to its home configuration
	...
	utils1.executeTraj(kukaID_e, "/MCRMCGtraj_", truePoses, path, idx1, idx2, executingServer)
	raw_input("delete the scene!")
	utils1.deleteTruePoses(truePoses, executingServer)
	raw_input("Press to put kuka to home configuration")
	## Put the kuka back to its home configuration
	...
	print "trajectories all executed"
